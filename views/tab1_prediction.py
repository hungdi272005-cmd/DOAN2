...
def render_tab1(selected_date, selected_model_type, selected_route, selected_hour, selected_weather, is_weekend, weekend_encoded, pred_dayofweek, pred_month, route_encoded, weather_encoded, rf_model, lstm_scaler, gru_scaler, le_route, le_weather, is_using_lstm, is_using_gru, load_keras_model, predict_speed, get_tomtom_features, has_realtime):
